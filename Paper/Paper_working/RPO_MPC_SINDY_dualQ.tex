...
\begin{figure}[h!]
	\centering\includegraphics[width=3.5in]{Figures/RelativeDynamics.png}
...
\begin{figure}[h!]
	\centering\includegraphics[width=3.5in]{Figures/SINDY_MPC.png}
	\caption{System identification using SINDY within model predictive control, for RPO.}
	\label{fig:SINDY_MPC}
\end{figure}
\begin{figure}[h!]
	\centering\includegraphics[width=3.5in]{Figures/SINDYC.png}
